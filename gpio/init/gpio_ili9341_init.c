...
const gpio_pin_cfg_t gpio_ili9341_cfg[GPIO_ILI9341_COUNT] = {
		...
		GPIO_PIN_CFG(GPIOB, GPIO_PIN_0, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_OSPEED_VERY_HIGH, GPIO_PUPD_NONE, GPIO_AF_0, GPIO_STATE_ON),		/*56, PB0,		GPIO_Output,	OFF,	Board_Out3_App*/
		GPIO_PIN_CFG(GPIOB, GPIO_PIN_1, GPIO_MODE_OUT, GPIO_OTYPE_PP, GPIO_OSPEED_VERY_HIGH, GPIO_PUPD_NONE, GPIO_AF_0, GPIO_STATE_ON)		/*57, PB1,		GPIO_Output,	OFF,	Board_Out4_App*/
};
