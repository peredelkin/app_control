...
/*1, PE2,		SPI4_SCK,		OFF,		SCLK_DI_App*/
...
/*3, PE4,		GPIO_Output,	ON,		CS_DO_App*/
/*4, PE5,		SPI4_MISO,		OFF,		MISO_DI_App*/
/*5, PE6,		SPI4_MOSI,		OFF,		MOSI_DI_App*/
/*7, PI8,		GPIO_Output,	ON,		CS_DI_App*/
...
/*11, PI9,		GPIO_Output,	ON,		Reset_DI_App*/
/*12, PI10,		GPIO_Input,		OFF,		Int_DI_App*/
/*13, PI11,		GPIO_Output,	OFF,	nCLR_App*/
/*16, PF0,		FMC_A0,			OFF,		SRAM_A0_App*/
/*17, PF1,		FMC_A1,			OFF,		SRAM_A1_App*/
/*18, PF2,		FMC_A2,			OFF,		SRAM_A2_App*/
/*19, PF3,		FMC_A3,			OFF,		SRAM_A3_App*/
/*20, PF4,		FMC_A4,			OFF,		SRAM_A4_App*/
/*21, PF5,		FMC_A5,			OFF,		SRAM_A5_App*/
/*24, PF6,		UART7_RX,		OFF,		Rx_Panel_App*/
/*25, PF7,		UART7_TX,		OFF,		Tx_Panel_App*/
/*26, PF8,		SPI5_MISO,		OFF,		MISO_SPI5_App*/
/*27, PF9,		SPI5_MOSI,		OFF,		MOSI_SPI5_App*/
/*28, PF10,		GPIO_Input,		OFF,		Dip0_App*/
...
/*32, PC0,		GPIO_Input,		OFF,		Dip1_App*/
/*33, PC1,		ETH_MDC,		OFF,		ETH_MDC_App*/
/*34, PC2,		GPIO_Output,	OFF,	OutDis_I_AO_App*/
...
/*43, PH2,		GPIO_Output,	ON,		ETH_Reset_App*/
...
/*51, PA5,		SPI1_SCK,		OFF,		SPI_SCK_App_MC*/
/*52, PA6,		SPI1_MISO,		OFF,		SPI_MISO_App_MC*/
/*53, PA7,		ETH_CRS_DV,		OFF,		ETH_CRS_DV_App*/
/*54, PC4,		ETH_RXD0,		OFF,		ETH_RXD0_App*/
/*55, PC5,		ETH_RXD1,		OFF,		ETH_RXD1_App*/
...
/*59, PF11,		GPIO_Output,	OFF,	NAND_nWP_App*/
/*60, PF12,		FMC_A6,			OFF,		SRAM_A6_App*/
/*63, PF13,		FMC_A7,			OFF,		SRAM_A7_App*/
/*64, PF14,		FMC_A8,			OFF,		SRAM_A8_App*/
/*65, PF15,		FMC_A9,			OFF,		SRAM_A9_App*/
/*66, PG0,		FMC_A10,		OFF,		SRAM_A10_App*/
/*67, PG1,		FMC_A11,		OFF,		SRAM_A11_App*/
/*68, PE7,		FMC_D4,			OFF,		SRAM_NAND_IO4_App*/
/*69, PE8,		FMC_D5,			OFF,		SRAM_NAND_IO5_App*/
/*70, PE9,		FMC_D6,			OFF,		SRAM_NAND_IO6_App*/
/*73, PE10,		FMC_D7,			OFF,		SRAM_NAND_IO7_App*/
/*74, PE11,		FMC_D8,			OFF,		SRAM_IO8_App*/
/*75, PE12,		FMC_D9,			OFF,		SRAM_IO9_App*/
/*76, PE13,		FMC_D10,		OFF,		SRAM_IO10_App*/
/*77, PE14,		FMC_D11,		OFF,		SRAM_IO11_App*/
/*78, PE15,		FMC_D12,		OFF,		SRAM_IO12_App*/
...
/*88, PH11,		TIM5_CH2,		OFF,		G_LED_App*/
...
/*98, PD10,		FMC_D15,		OFF,		SRAM_IO15_App*/
/*99, PD11,		FMC_A16 FMC_CLE,OFF,		SRAM_NAND_A16_App*/
/*100, PD12,	FMC_A17 FMC_ALE,OFF,		SRAM_NAND_A17_App*/
/*101, PD13,	FMC_A18,		OFF,		SRAM_A18_App*/
/*104, PD14,	FMC_D0,			OFF,		SRAM_NAND_IO0_App*/
/*105, PD15,	FMC_D1,			OFF,		SRAM_NAND_IO1_App*/
/*106, PG2,		FMC_A12,		OFF,		SRAM_A12_App*/
/*107, PG3,		FMC_A13,		OFF,		SRAM_A13_App*/
/*108, PG4,		FMC_A14,		OFF,		SRAM_A14_App*/
/*109, PG5,		FMC_A15,		OFF,		SRAM_A15_App*/
...
/*111, PG7,		GPIO_Input,		OFF,		ErrorAO1_App*/
/*112, PG8,		GPIO_Input,		OFF,		ErrorAO2_App*/
/*115, PC6,		USART6_TX,		OFF,		Tx_UART6_App*/
/*116, PC7,		USART6_RX,		OFF,		Rx_UART6_App*/
/*117, PC8,		SDIO_D0,		OFF,		SDIO_DAT0_App*/
/*118, PC9,		GPIO_Output,	ON,		SDIO_PWR_App*/
/*119, PA8,		GPIO_Input,		OFF,		SDIO_CD_App*/
/*120, PA9,		USART1_TX,		OFF,		UART_Tx_App_Jmp*/
/*121, PA10,	USART1_RX,		OFF,		UART_Rx_App_Jmp*/
...
/*128, PH13,	GPIO_Output,	ON,		SYNCAO_App*/
...
/*131, PI0,		GPIO_Output,	ON,		OE_App*/
/*132, PI1,		SPI2_SCK,		OFF,		SCLKAIO_App*/
/*133, PI2,		SPI2_MISO,		OFF,		MISOAIO_App*/
/*134, PI3,		SPI2_MOSI,		OFF,		MOSIAIO_App*/
...
/*138, PA15,	SPI1_NSS,		OFF,		SPI_CS_App_MC*/
/*139, PC10,	UART4_TX,		OFF,		Tx2_485_App_Jmp*/
/*140, PC11,	UART4_RX,		OFF,		Rx2_485_App_Jmp*/
/*141, PC12,	SDIO_CK,		OFF,		SDIO_CLK_App*/
/*142, PD0,		FMC_D2,			OFF,		SRAM_NAND_IO2_App*/
/*143, PD1,		FMC_D3,			OFF,		SRAM_NAND_IO3_App*/
/*144, PD2,		SDIO_CMD,		OFF,		SDIO_CMD_App*/
/*145, PD3,		GPIO_Output,	OFF,	Dir2_485_App_Jmp*/
/*146, PD4,		FMC_NOE,		OFF,		SRAM_NAND_nOE_App*/
/*147, PD5,		FMC_NWE,		OFF,		SRAM_NAND_nWE_App*/
/*150, PD6,		FMC_NWAIT,		OFF,		NAND_R\nB_App*/
/*151, PD7,		FMC_NE1,		OFF,		SRAM_nCE_App*/
/*152, PG9,		FMC_NCE3,		OFF,		NAND_nCE_App*/
/*153, PG10,	GPIO_Output,	OFF,	nLDAC_App*/
/*154, PG11,	ETH_TX_EN,		OFF,		ETH_TX_EN_App*/
/*155, PG12,	GPIO_Output,	OFF,	Relay1_DO_App*/
/*156, PG13,	GPIO_Output,	OFF,	Relay2_DO_App*/
/*157, PG14,	GPIO_Output,	OFF,	Relay3_DO_App*/
/*160, PG15,	GPIO_Output,	OFF,	Relay4_DO_App*/
...
/*163, PB5,		SPI1_MOSI,		OFF,		SPI_MOSI_App_MC*/
/*164, PB6,		GPIO_Output,	OFF,	Dir_Panel_App*/
...
/*167, PB8,		CAN1_RX,		OFF,		APP_CAN_RX*/
/*168, PB9,		CAN1_TX,		OFF,		APP_CAN_TX*/
/*169, PE0,		FMC_NBL0,		OFF,		SRAM_nBLE_App*/
/*170, PE1,		FMC_NBL1,		OFF,		SRAM_nBHE_App*/
/*173, PI4,		GPIO_Input,		OFF,		Board_ID0_App*/
/*174, PI5,		GPIO_Input,		OFF,		Board_ID1_App*/
/*175, PI6,		GPIO_Input,		OFF,		Board_ID2_App*/
/*176, PI7,		GPIO_Input,		OFF,		Board_ID3_App*/
//};
/*Elements count OK*/
