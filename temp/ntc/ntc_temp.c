...
METHOD_CALC_IMPL(M_ntc_temp, ntc_temp) {
	...
	ntc_temp->m_in_array_index = ntc_4901_index_mask & (msdi.out_analog[ntc_counter] >> ntc_4901_data_shift);

	index_1 = ntc_temp->m_in_array_index;
	index_2 = ntc_temp->m_in_array_index + 1;
