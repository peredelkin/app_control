...
typedef enum _E_Reg_Type {
	REG_TYPE_I8 =	0, //!< Целочисленное знаковое 8 бит.
	REG_TYPE_U8 =	1, //!< Целочисленное беззнаковое 8 бит.
	REG_TYPE_I16 =	2, //!< Целочисленное знаковое 16 бит.
	REG_TYPE_U16 =	3, //!< Целочисленное беззнаковое 16 бит.
    REG_TYPE_I32 =	4, //!< Целочисленное знаковое 32 бит.
    REG_TYPE_U32 =	5, //!< Целочисленное беззнаковое 32 бит.
