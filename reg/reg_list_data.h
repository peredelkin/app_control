...
REG(REG_ID_CLI_COUNT, &regs_data.cli.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_RGB_LED_COUNT, &regs_data.rgb_led.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_MSDI_COUNT, &regs_data.msdi.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_NTC_TEMP_COUNT, &regs_data.ntc_temp.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_DO_RELAY_COUNT, &regs_data.do_relay.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_DO_NCV7608_COUNT, &regs_data.do_ncv7608.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_DIGITAL_IN_COUNT, &regs_data.digital_in.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_MSO_COUNT, &regs_data.mso.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_AO_DAC7562_COUNT, &regs_data.ao_dac7562.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_PANEL_LED_COUNT, &regs_data.panel_led.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_MODBUS_REG_CAN_COUNT, &regs_data.modbus_reg_can.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
...
REG(REG_ID_CAN_TIM_COUNT, &regs_data.can_tim.count, REG_TYPE_U8, REG_FLAG_READONLY, 0x000000) /* Number of sub entries count */
