 ...
 * Результатом умножения числа QN на число QM
 * является число Q(N+M).
 * Для приведения к формату Q15 выполняет уменьшение
 * дробной части на Q15_FRACT_BITS бит, поэтому результатом
 * работы функции является число Q(N+M-Q15_FRACT_BITS).
 * @param a Число.
 * @param b Число.
 * @return Результат.
 */
 ...
 * Результатом деления числа QN на число QM
 * является число Q(N-M).
 * Для приведения к формату Q15 выполняет увеличение
 * дробной части на Q15_FRACT_BITS бит, поэтому результатом
 * работы функции является число Q(N-M+Q15_FRACT_BITS).
 * @param a Число.
 * @param b Число.
