...
void usart_buf_tx_rx_enable(USART_TypeDef* usart, bool tx_en, bool rx_en)
{
	usart_cr1_set(usart, USART_CR1_TE, tx_en);
	usart_cr1_set(usart, USART_CR1_RE, rx_en);
}

void usart_buf_enable(USART_TypeDef* usart, bool en)
{
	usart_cr1_set(usart, USART_CR1_UE, en);
}
