...
extern uint32_t can_RIR_read(CAN_TypeDef* CAN, int fifo);
extern uint32_t can_RDTR_read(CAN_TypeDef* CAN, int fifo);
extern uint32_t can_RDLR_read(CAN_TypeDef* CAN, int fifo);
extern uint32_t can_RDHR_read(CAN_TypeDef* CAN, int fifo);
...
extern void can_raw_rx_mailbox_read(CAN_TypeDef* CAN, int fifo, uint32_t* RIR, uint32_t* RDTR, uint32_t* RDLR, uint32_t* RDHR);
extern err_t can_rx_mailbox_read(CAN_TypeDef* CAN, int fifo, uint32_t* id, uint8_t* dlc, uint8_t* index, uint8_t* data);
extern void can_rx_mailbox_release(CAN_TypeDef* CAN, int fifo);
