...
#include "modules/temp/ntc/ntc_temp.h"

//! Перечисление возможных бит управления.
enum _E_Temp_Wind_Comp_Control {
    TEMP_WIND_COMP_CONTROL_NONE = CONTROL_NONE,
	TEMP_WIND_COMP_CONTROL_RESET = CONTROL_RESET,
	TEMP_WIND_COMP_CONTROL_ENABLE = CONTROL_ENABLE,
	TEMP_WIND_COMP_CONTROL_START = CONTROL_START,
	TEMP_WIND_COMP_CONTROL_STOP = CONTROL_STOP
};

//! Перечисление возможных бит статуса.
enum _E_Temp_Wind_Comp_Status {
    TEMP_WIND_COMP_STATUS_NONE = STATUS_NONE,
	TEMP_WIND_COMP_STATUS_READY = STATUS_READY,
	TEMP_WIND_COMP_STATUS_VALID = STATUS_VALID,
	TEMP_WIND_COMP_STATUS_RUN = STATUS_RUN,
	TEMP_WIND_COMP_STATUS_ERROR = STATUS_ERROR,
	TEMP_WIND_COMP_STATUS_WARNING = STATUS_WARNING,
};
