...
enum _E_Ntc_Temp_Control {
	...
	NTC_TEMP_CONTROL_RESET = CONTROL_RESET,
	NTC_TEMP_CONTROL_ENABLE = CONTROL_ENABLE,
	NTC_TEMP_CONTROL_START = CONTROL_START,
	NTC_TEMP_CONTROL_STOP = CONTROL_STOP,
	NTC_TEMP_CONTROL_USER = CONTROL_USER
};

//! Перечисление возможных бит статуса.
enum _E_Ntc_Temp_Status {
    NTC_TEMP_STATUS_NONE = STATUS_NONE,
	NTC_TEMP_STATUS_READY = STATUS_READY,
	NTC_TEMP_STATUS_VALID = STATUS_VALID,
	NTC_TEMP_STATUS_RUN = STATUS_RUN,
	NTC_TEMP_STATUS_ERROR = STATUS_ERROR,
	NTC_TEMP_STATUS_WARNING = STATUS_WARNING
};
